      ...
      <ContainerSmall>
        <>
          {itemsToRender.length ? (
            ...
            <div>There are no flights, try search again</div>
          )}
        </>
      </ContainerSmall>
    </FlightResultListWrapper>
